CREATE TABLE `simulation` (
	...
	`calculation` text,
	`travel_times` text,
	`artifacts_available` integer DEFAULT false NOT NULL,
	`error` text,
...
CREATE INDEX `simulation_compute_idx` ON `simulation` (`compute_backend`,`compute_job_id`);--> statement-breakpoint
