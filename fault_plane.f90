...
CLOSE(9)
write(*,*) 'Se leyeron los parámetros hipocentrales'

!write (*,*) 'Parametros hipocentrales'
!write (*,*) 'Hora origen (hhmm) = '
!read (*,*) t0
!write (*,*) 'Longitud = '
!read (*,*) xep
!write (*,*) 'Latitud = '
!read (*,*) yep
!write (*,*) 'Profundidad focal (km)= '
!read (*,*) zep
!write (*,*) 'Magnitud = '
!read (*,*) Mw
...
if (xep < xa(1)) then
  write(*,*) 'El epicentro esta fuera de la grilla computacional'
  call system ('rm meca.dat')
  call system ('rm pfalla.inp')
  stop 
end if
...
!-72.00  -36.0  22.0 360 18 90 9.0 0 0 
 ...
 WRITE(6,'(7f7.2 A5 A4)') xep, yep, zep, Az, echado, rake, Mw, ' 0 0 ', t0
 close(6)
